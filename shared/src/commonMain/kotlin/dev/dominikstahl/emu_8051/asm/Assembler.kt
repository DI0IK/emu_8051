...
class AssemblyResult private constructor(
    ...
    companion object {
        fun success(rom: UByteArray, sourceMap: Map<Int, Int> = emptyMap()) = AssemblyResult(rom, emptyList(), sourceMap)
        fun failure(errors: List<AssemblyError>) = AssemblyResult(null, errors)
    }
}
